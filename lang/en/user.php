...
return [
    ...
    'form' => [
        ...
        'addl_info' => [
            ...
            'h_m_t'=>'How many times have you availed mutual transfer ?',
            'no_m_f'=>'No Tranfser History Found!',
            'messages' => [
        ...
        'docs' => [
            ...
            5 => 'supporting_document ( if any )',
            6 => 'no_govt_due_certificate',
            7 => 'appointment_letter',
            8 => 'first_page_of_service_book',
        ],
        'sp_docs' => [
