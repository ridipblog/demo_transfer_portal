                                            ...
                                            <tr class="bg-gray-100">
                                                ...
                                                @if ($dept_count != 0)
                                                    <th class="p-4 px-6 font-medium text-sm text-gray-900" width="100px">
                                                        @lang('authority_dashboard.table.second_recommend_status')</th>
                                                    <th class="p-4 px-6 font-medium text-sm text-gray-900" width="100px">
                                                        @lang('authority_dashboard.table.approval_status')</th>
                                                @else
                                                    <th class="p-4 px-6 font-medium text-sm text-gray-900" width="100px">
                                                        @lang('authority_dashboard.table.status')</th>
                                                @endif
                                                <th class="text-left p-4 px-6 font-medium text-sm text-gray-900"
                                                    width="100px"></th>
                                            </tr>
...
@section('extra_js')
    ...
    <script>
        ...
        function fetch_candidate(data = null, office = null, pan = null, district = null, post = null) {
            $.ajax({
                type: "POST",
                url: "{{ url('verifier/fetch-candidates/approval') }}",
                data: {
                    'status': data,
                    'office': office,
                    'pan_search': pan,
                                    ...
                                    <td class="py-4 px-6 text-xs text-gray-900">${item.transfer_ref_code}</td>
                                     ...
                                     <td class="py-4 px-6 text-xs">
                                         <div class="flex gap-1 justify-center">
                                             <a href="/` + locale + `/verifier/approval-profile/` + item.encrypted_id + `" class="hover:bg-gray-200 border border-transparent text-gray-900 hover:text-black rounded-md block px-2 py-1.5 duration-300">
