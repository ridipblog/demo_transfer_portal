                                    ...
                                    <table class="min-w-full bg-white">
                                        <thead>
                                            <tr class="bg-gray-100">
                                                ...
                                                <th class="p-4 text-center px-6 font-medium text-sm text-gray-900"
                                                    width="100px">
                                        ...
                                        <thead>
                                            <tr class="bg-gray-100">
                                                ...
                                                <th class="p-4 px-6 font-medium text-sm text-gray-900" width="100px">
                                                    @lang('authority_dashboard.table.approval')</th>
                                                <th
                                                    class="text-left p-4 px-6 font-medium text-sm text-gray-900 text-center">
                                                    @lang('authority_dashboard.table.noc_col')</th>
                                                <th class="text-left p-4 px-6 font-medium text-sm text-gray-900"
                                                    width="300px">@lang('authority_dashboard.table.action')</th>
                                                {{-- <th class="text-left p-4 px-6 font-medium text-sm text-gray-900"
                                                    width="100px"></th> --}}
                                            </tr>
                                        </thead>
    ...
    <script>
        ...
        function fetch_candidate(data = null, office = null, pan = null, district = null, post = null) {
            $.ajax({
                ...
                success: function(response) {
                   ...
                   @lang('authority_dashboard.profile_details_jts.generate_transfer')
                                ...
                                // Determine the JTO generate status
                                let jto_status = item.jto_generate_status == 0 ?
                                    `<div
                                                    class="text-yellow-500 text-center border border-transparent text-white text-xs rounded block px-4 py-1.5 font-semibold w-fit">
                                                    Pending</div>` :
                                    `<div
                                                    class="text-green-500 text-center border border-transparent text-xs rounded block px-4 py-1.5 font-semibold w-fit">
                                                    Generated</div>`;
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td><div class="flex justify-center gap-1">${jto_status}</div> </td>
                <td> <div class="flex justify-left gap-1  ml-4">
                    ${jto} 
