...
@section('content')
    ...
    <div class="py-8">
        ...
        {{-- verification only --}}
        @if (in_array('Verifier', $user_roles_arr) || (in_array('Appointing User', $user_roles_arr) && $all_users != null))
    ...
    {{-- recommendation only --}}
    @if (in_array('Appointing Authority', $user_roles_arr) && !in_array('Appointing User', $user_roles_arr))
        @if (Auth::guard('user_guard')->user()->roles->role == 'Appointing Authority' &&
                !in_array('Appointing User', $user_roles_arr))
    ...
    @if (in_array('Appointing User', $user_roles_arr))
        ...
        @else
            @if (Auth::guard('user_guard')->user()->roles->role == 'Appointing User' ||
                    (in_array('Appointing Authority', $user_roles_arr) && in_array('Appointing User', $user_roles_arr)))
